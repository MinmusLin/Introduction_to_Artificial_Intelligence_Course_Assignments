...
class FlappyBird(object):
    ...
    base_image = load('sprites/base.png').convert_alpha()
    background_image = load('sprites/background.png').convert()
    pipe_images = [rotate(load('sprites/pipe.png').convert_alpha(), 180),
                   load('sprites/pipe.png').convert_alpha()]
    bird_images = [load('sprites/bird_upward.png').convert_alpha(),
                   load('sprites/bird_midflight.png').convert_alpha(),
                   load('sprites/bird_downward.png').convert_alpha()]
